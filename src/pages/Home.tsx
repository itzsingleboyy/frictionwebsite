        ...
        <main className="pt-16">
          ...
          <section className="min-h-[90vh] flex items-center justify-center relative overflow-hidden pt-20">
            ...
            <motion.div
              ...
              className="absolute top-[15%] left-[10%] w-16 h-16 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10"
            />
            <motion.div
              animate={{ y: [20, -20, 20], rotate: [0, -15, 15, 0] }}
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
              className="absolute top-[20%] right-[15%] w-12 h-12 rounded-full bg-white/5 backdrop-blur-sm border border-white/10"
            />
            <motion.div
              animate={{ y: [-15, 25, -15], scale: [1, 1.1, 1] }}
              transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
              className="absolute bottom-[25%] left-[8%] w-20 h-20 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10"
            />
            <motion.div
              animate={{ y: [15, -25, 15], rotate: [0, 360] }}
              transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
              className="absolute bottom-[30%] right-[10%] w-14 h-14 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10"
            />
            <motion.div
              animate={{ y: [-10, 30, -10], x: [-10, 10, -10] }}
              transition={{ duration: 9, repeat: Infinity, ease: "easeInOut" }}
              className="absolute top-[40%] left-[5%] w-10 h-10 rounded-full bg-white/5 backdrop-blur-sm border border-white/10"
            />
            <motion.div
              animate={{ y: [25, -15, 25], rotate: [0, -180, -360] }}
              transition={{ duration: 14, repeat: Infinity, ease: "easeInOut" }}
              className="absolute top-[60%] right-[8%] w-8 h-8 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10"
            />
