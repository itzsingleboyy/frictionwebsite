...
const DubaiVps = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Dubai VPS - AizyNodes</title>
        <meta name="description" content="High-performance VPS hosting in Dubai, UAE with excellent connectivity." />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm text-primary">Dubai VPS</span>
              </div>
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <h1 className="font-display text-5xl md:text-6xl font-bold">
                  <span className="gradient-text">Dubai VPS</span>
                </h1>
              </div>
              ...
              <p className="text-muted-foreground text-lg">
                High-performance servers in the Middle East with excellent connectivity.
              </p>
            </motion.div>
