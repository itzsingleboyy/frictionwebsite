...
const JapanVps = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Japan VPS - AizyNodes</title>
        <meta name="description" content="Ultra-fast VPS hosting in Tokyo, Japan with low ping for Asian gaming communities." />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-5xl md:text-6xl font-bold mb-6">
                <span className="gradient-text">Japan VPS Hosting</span>
              </h1>
              ...
              <p className="text-muted-foreground text-lg mb-4">
                Ultra-fast servers with low ping for Asian gaming communities.
              </p>
