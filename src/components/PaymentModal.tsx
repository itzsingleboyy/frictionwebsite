...
import { X, Copy, Check, CreditCard, Clock, Tag, Percent, Package, CheckCircle2 } from "lucide-react";
                ...
                <div className="bg-primary/10 border border-primary/30 rounded-xl p-4 mb-6">
                  <div className="flex items-center gap-3 justify-center">
                    ...
                    <p className="text-lg text-primary font-semibold">
                      Within 48 hours you will get your server!
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-accent/10 border border-accent/30 rounded-lg p-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-accent/80">
                      After payment, enter your transaction ID. Admin will verify and activate your servers within 48 hours.
                    </p>
                  </div>
                </div>
