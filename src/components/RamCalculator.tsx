...
const RamCalculator = () => {
  ...
  const getPlanName = (ram: number) => {
    ...
    if (ram <= 2) return "SPARK";
    if (ram <= 4) return "BLAZE";
    if (ram <= 6) return "INFERNO";
    if (ram <= 8) return "VOLCANO";
    return "MEGA SERVER";
  };
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="bg-zinc-900/50 backdrop-blur-lg border border-red-500/10 p-6 md:p-8 rounded-3xl"
            >
              {/* Quick Presets */}
              <div className="mb-6">
                <label className="text-sm text-zinc-400 mb-3 block font-medium">
                  Quick Presets
                </label>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                        selectedPreset === preset.name
                          ...
                          : "bg-zinc-800 text-zinc-400 border border-red-500/20 hover:border-red-500/40"
                      }`}
                    >
                      {preset.name}
                    </button>
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full bg-zinc-800 text-white px-4 py-3 rounded-xl border border-red-500/20 focus:border-red-500 focus:outline-none transition-colors"
                >
                  {versions.map((v) => (
              ...
              <button
                ...
                className="text-red-500 text-sm hover:text-red-400 transition-colors mb-4"
              >
                    ...
                    <div key={key} className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="w-8 h-8 rounded-lg bg-zinc-800 text-zinc-400 hover:bg-red-600 hover:text-white transition-colors border border-red-500/20"
                        >
                          -
                        </button>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="bg-zinc-900/50 backdrop-blur-lg border border-red-500/20 p-6 md:p-8 rounded-3xl"
            >
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-3xl font-display font-bold bg-gradient-to-r from-red-500 to-orange-400 bg-clip-text text-transparent">
                    {recommendedRam} GB
                  </span>
                </div>
              ...
              <div className="bg-gradient-to-br from-zinc-800/80 to-zinc-900/80 rounded-2xl p-6 mb-6 border border-red-500/20">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <span className="text-xs text-red-500 uppercase tracking-wider font-medium">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-zinc-400">~₹{pricePerPlayer}/player</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm">
                    <Cpu className="w-4 h-4 text-red-500" />
                    <span className="text-zinc-400">Ryzen 9 CPU (4GHz+)</span>
                  </div>
                </div>
              </div>
